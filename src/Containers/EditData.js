      ...
      .then((snapshot) => {
        (async () => {
          await dispatch.arsip.getAllArsip(
            `${DynamicData["SIKAD"].title.toUpperCase()}`
          );
  ...
  return editData !== null ? (
    <Formik
      ...
      initialValues={{
        ...
        hakCipta: editData.hakCipta,
        lokasiTempat: editData.lokasiTempat,
        keterangan: editData.keterangan,
        foto: editData.foto,
        tipeArsip: editData.tipeArsip,
        noDefinitif: editData.noDefinitif,
        tanggalSimpan: editData.tanggalSimpan,
      ...
      validationSchema={Yup.object({
        ...
        hakCipta: Yup.string().required("harus di isi"),
        lokasiTempat: Yup.string().required("harus di isi"),
        ...
        tanggalSimpan: Yup.string().required(" "),
      ...
      render={(formik) => (
        <React.Fragment>
          ...
          <ModalClick
            ...
            mainColor={DynamicData["SIKAD"].color.mainColor}
            secondColor={DynamicData["SIKAD"].color.thirdColor}
          />

          <ModalLoading
            visible={loading}
            color={DynamicData["SIKAD"].color.mainColor}
          />
        </React.Fragment>
      )}
    />
