  ...
  const loginAction = () => {
    ...
    FirebaseAuth.signInWithEmailAndPassword(
      ...
      .then((data) => {
        ...
        history.push(`/${DynamicData[type].title}/dashboard`);
      })
      .catch((error) => {
        setLoading(false);
          ...
          <Card className={"cardLoginForm"}>
            <Row>
              ...
              <Col span={17}>
                <p
                  className={"formTitle"}
                  style={{ color: `${DynamicData[type].color.mainColor}` }}
                >
                  {type}
                </p>
                <p className={"formSubTitle"}>{DynamicData[type].subTitle}</p>
              </Col>
            </Row>
                ...
                <Form.Item>
                  {register ? (
                    <Button
                      ...
                      style={{
                        backgroundColor: `${DynamicData[type].color.mainColor}`,
                      }}
                    >
                      Register
                    </Button>
